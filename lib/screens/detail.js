      ...
      return (
        <View>
          <TouchableOpacity
            ...
            <Icon name="call-outline" size={30} color="darkblue" />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.listItem}
            onLongPress={copyNomor}
      ...
      return (
        <View>
          <TouchableOpacity
            ...
            <Icon name="mail-outline" size={30} color="darkblue" />
          </TouchableOpacity>
        </View>
      );
  };
