...
export default function Detail({navigation, route}) {
  ...
  return (
    <View style={styles.container}>
      {/* <View style={{padding: 13, backgroundColor:'white', flexDirection:'row', elevation:6, alignContent: 'center',}}>
        <TouchableOpacity style={{alignSelf:'center'}} onPress={() => navigation.goBack(null)}>
          <Icon name="arrow-back-outline" size={24}/>
        </TouchableOpacity>
        <Text style={{fontSize:20, marginLeft:36, fontWeight:'600'}}>Detail</Text>
      </View> */}
      <Modal
        animationType="slide"
        transparent
        ...
        <View style={styles.modalSheetBackground}>
          ...
          <ScrollView style={styles.modalSheet}>
            ...
            <TouchableOpacity style={styles.addButton} onPress={updateKontak}>
